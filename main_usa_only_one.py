...
def main():
    ...
    utc_till = datetime.datetime.now() + datetime.timedelta(days=10)  # получим данные по завтрашний день
    print(utc_till)
    ...
    for timeframe in timeframes:
        for ticket in tickers:
            try:
                ...
                load_data.export_to_csv_from_df(ticket=ticket, timeframe=timeframe, data=data, export_dir=os.path.join(current_dir, "csv_export_usa_only_one"), by_timeframes=True)
